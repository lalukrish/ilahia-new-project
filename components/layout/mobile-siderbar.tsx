...
//   name: "Contact Us",
//   icon: "phone",
//   description: "Get in touch with ICLC.",
//   href: "/contact-us",
//   submenu: [],
// };

// export default function MobileMegaMenu({ menu, onClose }) {
//   const [activeParent, setActiveParent] = useState(null);
//   const [activeSubmenu, setActiveSubmenu] = useState(null);
//   const [openChild, setOpenChild] = useState(null);
//   const pathname = usePathname();

//   const mobileMenuItems = [...menu, contactDetails];
...
//             (grand) => grand.href && pathname === grand.href,
//           );
//         }
//         return false;
//       });
...
//   const isGrandActive = (grand) => grand.href && pathname === grand.href;
...
//                       const GrandIcon = iconMap[grand.icon];
